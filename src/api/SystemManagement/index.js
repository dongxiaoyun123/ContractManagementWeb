...
export function GetAdmin_Permission(PageIndex, PageSize) {
  return request({
    url: '/SystemManagement/GetAdmin_Permission?PageIndex=' + PageIndex + '&PageSize=' + PageSize,
    method: 'post',
  });
}
...
export function GetPermissionFirst(PermissionCode) {
  return request({
    url: '/SystemManagement/GetPermissionFirst?PermissionCode=' + PermissionCode,
    method: 'post',
  });
}
// 修改模块
...
export function GetRoleManagement(PageIndex, PageSize) {
  return request({
    url: '/SystemManagement/GetRoleManagement?PageIndex=' + PageIndex + '&PageSize=' + PageSize,
    method: 'post',
  });
}
// 获取模块树
...
export function GetMenuManagement(MenuName, PageIndex, PageSize) {
  return request({
    url: '/SystemManagement/GetMenuManagement?MenuName=' + MenuName + '&PageIndex=' + PageIndex + '&PageSize=' + PageSize,
    method: 'post',
  });
}
...
export function GetTeamManagement(TeamName, PageIndex, PageSize) {
  return request({
    url: '/SystemManagement/GetTeamManagement?TeamName=' + TeamName + '&PageIndex=' + PageIndex + '&PageSize=' + PageSize,
    method: 'post',
  });
}
...
export function GetDepartment(DepartmentName, PageIndex, PageSize) {
  return request({
    url: '/SystemManagement/GetDepartment?DepartmentName=' + DepartmentName + '&PageIndex=' + PageIndex + '&PageSize=' + PageSize,
    method: 'post',
  });
}
...
export function GetDepartmentFirst(DepartmentCode) {
  return request({
    url: '/SystemManagement/GetDepartmentFirst?DepartmentCode=' + DepartmentCode,
    method: 'post',
  });
}
...
export function GetDicCategory(Name, PageIndex, PageSize) {
  return request({
    url: '/SystemManagement/GetDicCategory?Name=' + Name + '&PageIndex=' + PageIndex + '&PageSize=' + PageSize,
    method: 'post',
  });
}
...
// 获取系统日志列表
export function GetSystemLog(PermissionCode, MenuDescription, Description, PageIndex, PageSize) {
  return request({
    url: '/SystemManagement/GetSystemLog?PermissionCode=' + PermissionCode + '&MenuDescription=' + MenuDescription + '&Description=' + Description + '&PageIndex=' + PageIndex + '&PageSize=' + PageSize,
    method: 'post',
  });
}
...
export function GetContractNameconfig(ContractName, PageIndex, PageSize) {
  return request({
    url: '/SystemManagement/GetContractNameconfig?ContractName=' + ContractName + '&PageIndex=' + PageIndex + '&PageSize=' + PageSize,
    method: 'post',
  });
}
...
export function GetContractNameconfigFirst(ContractCode) {
  return request({
    url: '/SystemManagement/GetContractNameconfigFirst?ContractCode=' + ContractCode,
    method: 'post',
  });
}
...
export function DeleteContractNameconfig(ContractCode) {
  return request({
    url: '/SystemManagement/DeleteContractNameconfig?ContractCode=' + ContractCode,
    method: 'post',
  });
}
...
export function GetDicCategoryC(Name, PageIndex, PageSize) {
  return request({
    url: '/SystemManagement/GetDicCategoryC?Name=' + Name + '&PageIndex=' + PageIndex + '&PageSize=' + PageSize,
    method: 'post',
  });
}
...
export function DeleteAttachment(BillingCode, FileName) {
  return request({
    url: '/SystemManagement/DeleteAttachment?BillingCode=' + BillingCode + '&FileName=' + FileName,
    method: 'post',
  });
}
...
export function GetInvoiceAccount(InvoiceAccountName, PageIndex, PageSize) {
  return request({
    url: '/SystemManagement/GetInvoiceAccount?InvoiceAccountName=' + InvoiceAccountName + '&PageIndex=' + PageIndex + '&PageSize=' + PageSize,
    method: 'post',
  });
}
...
export function GetInvoiceAccountFirst(InvoiceAccountCode) {
  return request({
    url: '/SystemManagement/GetInvoiceAccountFirst?InvoiceAccountCode=' + InvoiceAccountCode,
    method: 'post',
  });
}
...
export function DeleteInvoiceAccount(InvoiceAccountCode) {
  return request({
    url: '/SystemManagement/DeleteInvoiceAccount?InvoiceAccountCode=' + InvoiceAccountCode,
    method: 'post',
  });
}
// //获取供应商列表
...
export function GetSupplierCmpanyB(SupplierCmpanyBName, PageIndex, PageSize) {
  return request({
    url: '/SystemManagement/GetSupplierCmpanyB?SupplierCmpanyBName=' + SupplierCmpanyBName + '&PageIndex=' + PageIndex + '&PageSize=' + PageSize,
    method: 'post',
  });
}
...
export function DeleteSupplierCmpanyB(SupplierCmpanyBCode) {
  return request({
    url: '/SystemManagement/DeleteSupplierCmpanyB?SupplierCmpanyBCode=' + SupplierCmpanyBCode,
    method: 'post',
  });
}
...
export function AddCompanyRelation(ComID, CompanyrelationName) {
  return request({
    url: '/SystemManagement/AddCompanyRelation?ComID=' + ComID + '&CompanyrelationName=' + CompanyrelationName,
    method: 'post',
  });
}
// 删除客户曾用名

    ...
    <div class="right-menu">
      ...
      >
        <el-form :inline="true" style="color: white;height: 50px;cursor: pointer;">
          ...
          <el-form-item>
            <el-tooltip v-if="realname.length > 3" class="item" effect="dark" :content="realname" placement="left">
              <div
                style="width:60px;white-space: nowrap;text-overflow:ellipsis; overflow:hidden;color: black;height: 50px;line-height: 50px;"
              >
                {{ realname }}</div>
            </el-tooltip>
            <div v-else
      ...
      >
        ...
        <el-row class="buttonCenter">
          <el-col>
            <el-button type="primary" :loading="UpdatePasswordLoading" @click="UpdatePasswordClick">
              确 定
            </el-button>

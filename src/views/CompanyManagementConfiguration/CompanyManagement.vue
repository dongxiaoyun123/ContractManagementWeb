<template>
  <div style="padding: 8px;">
    ...
    <el-card class="CardTableClass">
      ...
      <el-table v-loading="loading" highlight-current-row :data="DicCategoryList">
        ...
        <el-table-column label="操作" width="170px">
          <template slot-scope="scope">
            ...
            <el-button icon="el-icon-edit" type="text" size="mini" @click="AddDialog(false, scope.row)">编辑</el-button>
            <el-button icon="el-icon-s-ticket" type="text" size="mini" @click="showEditDialog(scope.row)">开票信息</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页区域 -->
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="公司名称" prop="ComName">
              <el-input v-model="AddCompanyForm.ComName" :disabled="disabledFlag && !flag" placeholder="公司名称" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="公司简称" prop="ShortName">
              <el-input v-model="AddCompanyForm.ShortName" :disabled="disabledFlag && !flag" placeholder="公司简称" />
            </el-form-item>
          </el-col>
        </el-row>
  ...
  methods: {
    ...
    AddDialog(flag, row) {
      ...
      if (flag) {
        ...
        this.AddCompanyForm.TaxpayerIdentificationNumber = row.TaxpayerIdentificationNumber;
      }
